    ...
    return (
        <div className="bg-slate-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                {/* Header Section */}
                <div className="bg-indigo-600 px-6 py-8 md:p-10 text-center">
                ...
                <div className="p-6 md:p-10 space-y-8 text-gray-700 leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 mb-3 border-b pb-2 border-slate-100">
                ...
                {/* Footer Section */}
                <div className="bg-slate-50 px-6 py-6 md:px-10 flex flex-col sm:flex-row items-center justify-between border-t border-gray-100 gap-4">
