            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="relative w-full h-75 md:h-112.5 rounded-2xl overflow-hidden bg-gray-100 dark:bg-slate-900 shadow-sm">
                            <Image
                        ...
                        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800/60 p-6 rounded-2xl shadow-sm">
                            ...
                            <div className="mt-6 pt-6 border-t border-gray-100 dark:border-slate-800/60">
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">About This Vehicle</h3>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800/60 p-6 rounded-2xl shadow-sm sticky top-6">
                            ...
                            <div className="mb-6">
                                <p className="text-gray-400 dark:text-gray-500 text-xs uppercase font-semibold tracking-wider">Rental Price</p>
                                <div className="flex items-baseline gap-1 mt-1">
                                    <span className="text-3xl font-black text-gray-950 dark:text-white">${price}</span>
                            ...
                            <div className="space-y-4 my-6 pt-4 border-t border-gray-100 dark:border-slate-800/60">
                                <div className="flex justify-between text-sm">
                                    <span className="text-gray-500 dark:text-slate-400"><MdEventSeat /> Seating Capacity</span>
                                    <span className="font-bold text-gray-900 dark:text-white">{seatCapacity} Seats</span>
                                </div>
                                <div className="flex justify-between text-sm">
                                    <span className="text-gray-500 dark:text-slate-400"><FaMapPin /> Pickup Location</span>
                            ...
                            <button 
                                ...
                                className={`w-full py-3 px-4 rounded-xl text-sm font-semibold transition-all duration-200 shadow-sm ${
                                    availabilityStatus === "Available"
                            ...
                            >
                                {availabilityStatus === "Available" ? "Book This Car Now" : "Currently Unavailable"}
                            </button>
